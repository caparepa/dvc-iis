  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li><a href="bower_components/AdminLTE/documentation/index.html"><i class="fa fa-book"></i> <span>Documentation</span></a></li>
      ...
      <div class="error-page">
        ...
        <div class="error-content">
          ...
          <p>
            ...
            Meanwhile, you may <a href="bower_components/AdminLTE/index.html">return to dashboard</a> or try using the search form.
          </p>
